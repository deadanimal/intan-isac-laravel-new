...
CKEDITOR.lang["en"] = {
    ...
    tablesorter: {
        contextAsc: "Sort ascending",
        contextDesc: "Sort descending",
    },
    toc: {
    ...
    spacingsliders: {
        title: "Spacing",
        labels: { lineheight: "Spacing" },
    },
    // spacingsliders: {
    //     title: "Line and Letter Spacing",
    //     labels: { lineheight: "Line Height", letterspacing: "Letter Spacing" },
    // },
    allowsave: { toolbar: "Save" },
    pbckcode: {
        title: "PBCKCODE",
        addCode: "Add code",
        editCode: "Edit code",
    ...
    docprops: {
        ...
        other: "Other...",
        previewHtml:
            '<p>This is some <strong>sample text</strong>. You are using <a href="javascript:void(0)">CKEditor</a>.</p>',
