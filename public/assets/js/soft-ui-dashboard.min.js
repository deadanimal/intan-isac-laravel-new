...
function initNavs() {
    total.forEach(function (l, e) {
        ...
        (o.style.padding = "0px"),
            (o.style.width =
                l.querySelector("li:nth-child(1)").offsetWidth + "px"),
                    ...
                    l.querySelector(
                        ...
                        if (l.classList.contains("flex-column")) {
                            ...
                            (o.style.transform =
                                ...
                                (o.style.width =
                                    l.querySelector("li:nth-child(" + a + ")")
                                        .offsetWidth + "px");
                        }
                    };
                }
            ...
            if (l) {
                ...
                if (n.classList.contains("flex-column")) {
                    ...
                    (a.style.transform = "translate3d(0px," + t + "px, 0px)"),
                        (a.style.width =
                            n.querySelector("li:nth-child(" + i + ")")
                                .offsetWidth + "px"),
            ...
            window.innerWidth < 991
                ? total.forEach(function (a, e) {
                      if (!a.classList.contains("flex-column")) {
                          ...
                          (l.style.width =
                              a.querySelector("li:nth-child(1)").offsetWidth +
                              "px"),
                              (l.style.transform =
                                  "translate3d(0px," + n + "px, 0px)");
                      }
                  })
                : total.forEach(function (a, e) {
            ...
            (sidenavToggler.onclick = function () {
                sidenavShow.classList.contains("g-sidenav-hidden")
                    ...
                    : (sidenavShow.classList.remove("g-sidenav-pinned"),
                      ...
                      toggleNavbarMinimize &&
                          (toggleNavbarMinimize.click(),
                          toggleNavbarMinimize.setAttribute(
                              "checked",
                              "true"
                          )));
            }));
    ...
    initVectorMap: function () {
        am4core.ready(function () {
            ...
            (t.tooltipText = "{name}"),
                ...
                (t.states.create("hover").properties.fill =
                    e.colors.getIndex(0));
