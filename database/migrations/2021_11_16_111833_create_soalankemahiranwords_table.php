...
class CreateSoalankemahiranwordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('soalankemahiranwords', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('soalankemahiranwords');
    }
}
