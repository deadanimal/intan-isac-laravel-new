                    ...
                    <div class="card-header position-relative z-index-1" style="background-color:#FFA500;">
                        <div class="row d-flex flex-nowrap">
                            <div class="col align-items-center">
                                ...
                                <h6 class="text-white">True or false</h6>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="/bank-soalan-pengetahuan/true-false" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        @if ($banksoalanpengetahuan->jawapan == 'True')
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" value="True" type="radio" name="jawapan"
                                                    id="customRadio_true" checked>
                                                <label class="custom-control-label" for="customRadio_true">True</label>
                                            </div>
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" value="False" type="radio" name="jawapan"
                                                    id="customRadio_false">
                                                <label class="custom-control-label" for="customRadio_false">False</label>
                                            </div>
                                        @else
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" value="True" type="radio" name="jawapan"
