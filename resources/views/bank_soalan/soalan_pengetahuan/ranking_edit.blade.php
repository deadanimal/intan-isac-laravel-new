                    ...
                    <div class="card-header position-relative z-index-1" style="background-color:#FFA500;">
                        <div class="row d-flex flex-nowrap">
                            <div class="col align-items-center">
                                ...
                                <h6 class="text-white mb-0">Ranking</h6>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="/bank-soalan-pengetahuan/ranking" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-2" name="pilihan_jawapan"
                                            rows="3">{{ $banksoalanpengetahuan->pilihan_jawapan }}</textarea>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-2" name="pilihan_jawapan1"
                                            rows="3">{{ $banksoalanpengetahuan->pilihan_jawapan1 }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-2" name="pilihan_jawapan2"
                                            rows="3">{{ $banksoalanpengetahuan->pilihan_jawapan2 }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-2" name="pilihan_jawapan3"
                                            rows="3">{{ $banksoalanpengetahuan->pilihan_jawapan3 }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-2" name="pilihan_jawapan4"
                                            rows="3">{{ $banksoalanpengetahuan->pilihan_jawapan4 }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" style="text-transform: uppercase" type="text"
                                            name="jawapan" value="{{ $banksoalanpengetahuan->jawapan }}">
