                    ...
                    <div class="card-header position-relative z-index-1" style="background-color:#FFA500;">
                        <div class="row d-flex flex-nowrap">
                            <div class="col align-items-center">
                                ...
                                <h6 class="text-white mb-0">Single Choice</h6>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="/bank-soalan-pengetahuan/single-choice" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check mb-3">
                                            @if ($banksoalanpengetahuan->jawapan == $banksoalanpengetahuan->pilihan_jawapan1)
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check mb-3">
                                            @if ($banksoalanpengetahuan->jawapan == $banksoalanpengetahuan->pilihan_jawapan2)
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check mb-3">
                                            @if ($banksoalanpengetahuan->jawapan == $banksoalanpengetahuan->pilihan_jawapan3)
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check mb-3">
                                            @if ($banksoalanpengetahuan->jawapan == $banksoalanpengetahuan->pilihan_jawapan4)
