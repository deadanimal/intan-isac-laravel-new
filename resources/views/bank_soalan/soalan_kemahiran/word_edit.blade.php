...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Soalan Kemahiran Pemprosesan Perkataan
            </li>
        </ol>
    ...
    <div class="container-fluid py-4">
        <div class="card card-frame mt-4">
            ...
            <div class="card-body">
                <form method="POST"
                    action="/{{ $soalankemahiranwords->id_soalankemahiran }}/pemprosesan-perkataan/{{ $soalankemahiranwords->id }}/save"
                    enctype="multipart/form-data">
                    {{-- @method('PUT') --}}
                    @csrf
                    <div class="row">
                        <input type="hidden" name="id_soalankemahiran"
                            value="{{ $soalankemahiranwords->id_soalankemahiran }}">
                        <div class="col-xl-6">
                            <div class="form-group">
                                <label class="form-control-label">Tahap Soalan</label>
                                <select class="form-control" name="tahap_soalan" required>
                                    <option hidden selected value="{{ $soalankemahiranwords->tahap_soalan }}">
                                        {{ $soalankemahiranwords->tahap_soalan }}</option>
                        ...
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <textarea id="editor-arahan-umum" class="form-control"
                                    name="arahan_umum">{{ $soalankemahiranwords->arahan_umum }}</textarea>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3"
                                    name="arahan_soalan">{{ $soalankemahiranwords->arahan_soalan }}</textarea>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label class="form-control-label">Bahagian Soalan</label>
                                <input class="form-control" type="text" value="Bahagian B" disabled="">
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label class="form-control-label">Bentuk Soalan</label>
                                <input class="form-control" type="text" value="Pemprosesan Perkataan" disabled="">
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status_soalan" required>
                                    @if ($soalankemahiranwords->status_soalan == 1)
                                        <option hidden selected value="{{ $soalankemahiranwords->status_soalan }}">
                                            Aktif</option>
                                    @else
                                        <option hidden selected value="{{ $soalankemahiranwords->status_soalan }}">
                                            Tidak Aktif</option>
                        ...
                        <div class="col-xl-12">
                            <div class="table-responsive">
                                <table class="table table-flush" id="datatable_soalan_jawapan_internet">
                                    ...
                                    <tbody>
                                        {{-- @if ($soalankemahiranwords->soalan_1 != null) --}}
                                        <tr>
                                            <td>1</td>
                                            <td><textarea id="editor-soalan-1" class="form-control" name="soalan_1"
                                                    rows="3">{{ $soalankemahiranwords->soalan_1 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_1" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_1 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_1"
                                                    value="{{ $soalankemahiranwords->markah_1 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_2 != null) --}}
                                        <tr>
                                            <td>2</td>
                                            <td><textarea id="editor-soalan-2" class="form-control" name="soalan_2"
                                                    rows="3">{{ $soalankemahiranwords->soalan_2 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_2" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_2 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_2"
                                                    value="{{ $soalankemahiranwords->markah_2 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_3 != null) --}}
                                        <tr>
                                            <td>3</td>
                                            <td><textarea id="editor-soalan-3" class="form-control" name="soalan_3"
                                                    rows="3">{{ $soalankemahiranwords->soalan_3 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_3" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_3 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_3"
                                                    value="{{ $soalankemahiranwords->markah_3 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_4 != null) --}}
                                        <tr>
                                            <td>4</td>
                                            <td><textarea id="editor-soalan-4" class="form-control" name="soalan_4"
                                                    rows="3">{{ $soalankemahiranwords->soalan_4 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_4" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_4 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_4"
                                                    value="{{ $soalankemahiranwords->markah_4 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_5 != null) --}}
                                        <tr>
                                            <td>5</td>
                                            <td><textarea id="editor-soalan-5" class="form-control" name="soalan_5"
                                                    rows="3">{{ $soalankemahiranwords->soalan_5 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_5" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_5 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_5"
                                                    value="{{ $soalankemahiranwords->markah_5 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_6 != null) --}}
                                        <tr>
                                            <td>6</td>
                                            <td><textarea id="editor-soalan-6" class="form-control" name="soalan_6"
                                                    rows="3">{{ $soalankemahiranwords->soalan_6 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_6" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_6 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_6"
                                                    value="{{ $soalankemahiranwords->markah_6 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_7 != null) --}}
                                        <tr>
                                            <td>7</td>
                                            <td><textarea id="editor-soalan-7" class="form-control" name="soalan_7"
                                                    rows="3">{{ $soalankemahiranwords->soalan_7 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_7" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_7 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_7"
                                                    value="{{ $soalankemahiranwords->markah_7 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_8 != null) --}}
                                        <tr>
                                            <td>8</td>
                                            <td><textarea id="editor-soalan-8" class="form-control" name="soalan_8"
                                                    rows="3">{{ $soalankemahiranwords->soalan_8 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_8" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_8 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_8"
                                                    value="{{ $soalankemahiranwords->markah_8 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_9 != null) --}}
                                        <tr>
                                            <td>9</td>
                                            <td><textarea id="editor-soalan-9" class="form-control" name="soalan_9"
                                                    rows="3">{{ $soalankemahiranwords->soalan_9 }}</textarea>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea id="editor-soalan-11" class="form-control" name="soalan_11"
                                                    rows="3">{{ $soalankemahiranwords->soalan_11 }}</textarea>
                                            </td>
                                        ...
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_12 != null) --}}
                                        <tr>
                                            <td>12</td>
                                            <td><textarea id="editor-soalan-12" class="form-control" name="soalan_12"
                                                    rows="3">{{ $soalankemahiranwords->soalan_12 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_12" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_12 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_12"
                                                    value="{{ $soalankemahiranwords->markah_12 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_13 != null) --}}
                                        <tr>
                                            <td>13</td>
                                            <td><textarea id="editor-soalan-13" class="form-control" name="soalan_13"
                                                    rows="3">{{ $soalankemahiranwords->soalan_13 }}</textarea>
                                            </td>
                                        ...
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_14 != null) --}}
                                        <tr>
                                            <td>14</td>
                                            <td><textarea id="editor-soalan-14" class="form-control" name="soalan_14"
                                                    rows="3">{{ $soalankemahiranwords->soalan_14 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_14" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_14 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_14"
                                                    value="{{ $soalankemahiranwords->markah_14 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                        {{-- @if ($soalankemahiranwords->soalan_15 != null) --}}
                                        <tr>
                                            <td>15</td>
                                            <td><textarea id="editor-soalan-15" class="form-control" name="soalan_15"
                                                    rows="3">{{ $soalankemahiranwords->soalan_15 }}</textarea>
                                            </td>
                                            <td><textarea class="form-control" name="jawapan_15" rows="3"
                                                    style="width: 100%; height: 100%;">{{ $soalankemahiranwords->jawapan_15 }}</textarea>
                                            </td>
                                            <td><input class="form-control" type="text" name="markah_15"
                                                    value="{{ $soalankemahiranwords->markah_15 }}"></td>
                                        </tr>
                                        {{-- @endif --}}
                                    </tbody>
                                </table>
