...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="card card-frame mt-4">
            ...
            <div class="card-body">
                <form method="POST" action="/{{ $banksoalankemahirans->id }}/pemprosesan-perkataan/save"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3"
                                    name="arahan_soalan">Anda dikehendaki menyediakan dokumen MS Word. Ikut arahan seperti di bawah :-</textarea>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                        ...
                        <div class="col-xl-12">
                            <div class="table-responsive">
                                <table class="table table-flush" id="datatable_soalan_jawapan_word">
    ...
    <script>
        $(document).ready(function() {
            var t = $('#datatable_soalan_jawapan_word').DataTable({
                dom: 'Bfrtip',
                pageLength: 15,
                "ordering": false,
                "searching": false,
