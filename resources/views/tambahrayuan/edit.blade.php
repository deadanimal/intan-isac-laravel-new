    ...
    <div class="container-fluid py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Balas Rayuan</a></li>
            </ol>
            <h5 class="font-weight-bolder">Balas Rayuan</h5>
        </nav>
        <div class="col-xl-12">
            @if ($errors->any())
            ...
            <form method="POST" action="/tambahrayuans/{{ $tambahrayuan->id }}" enctype="multipart/form-data">
                ...
                <div class="card mt-4" id="basic-info">
                    <div class="card-header" style="background-color:#FFA500;">
                        <b class="text-white mb-0">Balas Rayuan</b>
                    </div>
                    <br>
