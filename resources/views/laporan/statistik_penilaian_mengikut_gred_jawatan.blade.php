...
@section('content')
    ...
    <div class="container-fluid py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Laporan Statistik Penilaian Mengikut
                    Klasifikasi Gred
                    & Jawatan</li>
            </ol>
            <h5 class="font-weight-bolder">Laporan Statistik Penilaian Mengikut Klasifikasi Gred
                & Jawatan</h5>
        </nav>
                    ...
                    <form style="width: 100%;" (ngSubmit)="filterCharts()">
                        ...
                        <div class="row">
                            ...
                            <div class="col-5">
                                ...
                                <select class="form-control form-control-sm" name="input_perkidmatan"
                                    id="input_perkidmatan">
                            ...
                            <div class="col-5">
                                <label for="input_jawatan">Gred Jawatan</label>
                                <select class="form-control form-control-sm" name="input_jawatan" id="input_jawatan">
                                    <option hidden selected value="">
                                        Sila Pilih
                                    </option>
                            ...
                            <div class="col d-flex justify-content-end align-items-end mt-3">
                                ...
                                <a href="/laporan/statistik-penilaian-mengikut-klasifikasi-gred-jawatan"
        ...
        <div class="card mt-3">
            ...
            <div class="card-body p-3">
                <div class="table-responsive">
                    <table class="table align-items-center mb-0" id="tablestatistikikutgred">
                        <thead>
                            <tr>
    ...
    <script>
        $(document).ready(function() {
            $('#tablestatistikikutgred').DataTable({
                dom: 'Bfrtip',
                pageLength: 13,
                "ordering": false,
                "searching": false,
