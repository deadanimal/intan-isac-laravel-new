...
class JadualKemaskiniPenangguhan extends Mailable
{
    ...
    {
        $this->jadual = $jadual;
        $this->tajuk = 'ISAC - Kemaskini Jadual: Penangguhan';
    }
    ...
    {
        return $this->view('emails.jadual_kemaskini_penangguhan')->subject($this->tajuk)->with([
